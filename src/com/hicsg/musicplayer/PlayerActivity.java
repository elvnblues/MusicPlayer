...
public class PlayerActivity extends ListActivity {
    ...
    public void musicList(){
        ...
        if(home.listFiles(new MusicFilter()).length>0){
            ...
            (PlayerActivity.this,R.layout.musicitme, myMusicList);
    ...
    //获取按钮
   void findView(){
       viewHolder.start=(ImageView)findViewById(R.id.start);
       viewHolder.stop=(ImageView)findViewById(R.id.stop);
       viewHolder.next=(ImageView)findViewById(R.id.next);
       viewHolder.pause=(ImageView)findViewById(R.id.pause);
       viewHolder.last=(ImageView)findViewById(R.id.last);
   }
